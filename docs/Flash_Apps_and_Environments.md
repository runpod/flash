...
- **Flash Build**: Tarball artifacts uploaded per app (.flash/artifact.tar.gz). Used for extracting manifest and deploying to endpoints during resource provisioning.
