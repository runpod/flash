...
# NOTE: TestCleanupPythonBytecode and TestInstallDependenciesNoDeps were removed
# because they duplicated tests in test_p2_gaps.py (TestBuildPycacheCleaning
# and TestBuildNoDependencies respectively).
