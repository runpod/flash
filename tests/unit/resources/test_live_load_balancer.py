...
class TestLiveLoadBalancer:
    ...
    def test_live_load_balancer_default_base_image(self):
        """Test LiveLoadBalancer uses GPU base image by default."""
    ...
    def test_live_load_balancer_user_can_override_image(self):
        ...
        assert lb.template.imageName == "custom/image:v1"
...
class TestTemplateSerializationRoundtrip:
    ...
    def test_live_load_balancer_serialization_roundtrip(self):
        ...
        # Base image used instead of flash-worker image
        assert payload["template"]["imageName"] == FLASH_GPU_BASE_IMAGE
...
class TestCpuLiveLoadBalancer:
    ...
    def test_cpu_live_load_balancer_default_base_image(self):
        """Test CpuLiveLoadBalancer uses CPU base image by default."""
